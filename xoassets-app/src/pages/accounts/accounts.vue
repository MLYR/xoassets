...
.accounts-page { min-height: 100vh; background: $bg-color; }
.total-section {
...
.total-label { font-size: $font-sm; color: rgba(255,255,255,0.8); display: block; margin-bottom: 8rpx; }
.total-value { font-size: $amount-huge; font-weight: 800; color: #fff; }
...
.ac-name { font-size: $font-lg; font-weight: 600; color: $text-primary; }
.ac-type { font-size: $font-xs; color: $text-secondary; margin-top: 4rpx; }
.ac-balance { font-size: $amount-md; font-weight: 700; color: $text-primary; }
</style>
