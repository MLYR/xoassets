...
- 投资收益：明细页展示投资总市值、今日收益、昨日收益、总收益、收益率、持仓数量，并在表格展示当前价、昨价、今日涨跌、今日收益、昨日收益、总收益和回本涨幅；收益基准缺失时展示 `--`，不使用其他字段伪造 0；持仓详情页展示当前市值、持仓数量、成本、今日收益、总收益、总收益率、已实现盈亏、回本涨幅、价格快照和当前持仓交易记录。
