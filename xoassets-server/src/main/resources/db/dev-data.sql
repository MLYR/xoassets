...
DELETE FROM xo_asset_price_daily;
DELETE FROM xo_asset_price_current;
...
INSERT INTO xo_investment_transaction (id, user_id, holding_id, asset_id, account_id, type, quantity, price, amount, fee, cost_amount, realized_profit, status, revoke_time, revoke_reason, transaction_time, note, created_at, updated_at, deleted)
VALUES
  (1600000000000000001, 1000000000000000001, 1500000000000000001, 1400000000000000001, 1100000000000000001, 'BUY', 1000.0000, 0.6000, 600.0000, 0.0000, 600.0000, NULL, 'NORMAL', NULL, NULL, '2026-05-03 10:00:00', '买入 DOGE', NOW(), NOW(), 0),
  (1600000000000000002, 1000000000000000001, 1500000000000000001, 1400000000000000001, 1100000000000000001, 'SELL', 118.6780, 0.7000, 83.0746, 0.0000, 71.2068, 11.8678, 'NORMAL', NULL, NULL, '2026-05-20 10:00:00', '卖出部分 DOGE', NOW(), NOW(), 0),
  (1600000000000000003, 1000000000000000001, 1500000000000000002, 1400000000000000002, 1100000000000000001, 'BUY', 1000.0000, 1.2345, 1234.5000, 0.0000, 1234.5000, NULL, 'NORMAL', NULL, NULL, '2026-05-06 14:00:00', '买入基金 A', NOW(), NOW(), 0);

INSERT INTO xo_asset_price_current (asset_id, price, currency, previous_close, change_amount, change_percent, source, quote_time, market_status, raw_json, created_at, updated_at)
VALUES
  (1400000000000000001, 0.72432000, 'USD', 0.70000000, 0.02432000, 3.4743, 'MANUAL', '2026-05-31 09:00:00', 'MANUAL', '{"demo":true}', NOW(), NOW()),
  (1400000000000000002, 1.25000000, 'CNY', 1.24000000, 0.01000000, 0.8065, 'MANUAL', '2026-05-31 09:00:00', 'MANUAL', '{"demo":true}', NOW(), NOW());

INSERT INTO xo_asset_price_daily (id, asset_id, trade_date, open_price, close_price, high_price, low_price, previous_close, change_amount, change_percent, currency, source, created_at, updated_at, deleted)
VALUES
  (1700000000000000001, 1400000000000000001, '2026-05-31', 0.72432000, 0.72432000, 0.72432000, 0.72432000, 0.70000000, 0.02432000, 3.4743, 'USD', 'MANUAL', NOW(), NOW(), 0),
  (1700000000000000002, 1400000000000000002, '2026-05-31', 1.25000000, 1.25000000, 1.25000000, 1.25000000, 1.24000000, 0.01000000, 0.8065, 'CNY', 'MANUAL', NOW(), NOW(), 0),
  (1700000000000000003, 1400000000000000001, '2026-05-30', 0.70000000, 0.70000000, 0.70000000, 0.70000000, 0.68000000, 0.02000000, 2.9412, 'USD', 'MANUAL', NOW(), NOW(), 0),
  (1700000000000000004, 1400000000000000001, '2026-05-29', 0.68000000, 0.68000000, 0.68000000, 0.68000000, NULL, NULL, NULL, 'USD', 'MANUAL', NOW(), NOW(), 0),
  (1700000000000000005, 1400000000000000002, '2026-05-30', 1.24000000, 1.24000000, 1.24000000, 1.24000000, 1.23000000, 0.01000000, 0.8130, 'CNY', 'MANUAL', NOW(), NOW(), 0),
  (1700000000000000006, 1400000000000000002, '2026-05-29', 1.23000000, 1.23000000, 1.23000000, 1.23000000, NULL, NULL, NULL, 'CNY', 'MANUAL', NOW(), NOW(), 0);
