...
CREATE TABLE IF NOT EXISTS xo_investment_daily_snapshot (
  ...
  calendar_profit DECIMAL(18,4) DEFAULT NULL COMMENT '收益日历展示日收益，按持仓每日收益聚合',
  calendar_profit_rate DECIMAL(18,4) DEFAULT NULL COMMENT '收益日历展示日收益率',
  calendar_base_amount DECIMAL(18,4) DEFAULT NULL COMMENT '收益日历收益率基准金额',
  buy_amount DECIMAL(18,4) NOT NULL DEFAULT 0 COMMENT '当日买入本金合计',
  sell_amount DECIMAL(18,4) NOT NULL DEFAULT 0 COMMENT '当日卖出成交本金合计',
  fee_amount DECIMAL(18,4) NOT NULL DEFAULT 0 COMMENT '当日投资交易手续费合计',
  buy_count INT NOT NULL DEFAULT 0 COMMENT '当日买入笔数',
  sell_count INT NOT NULL DEFAULT 0 COMMENT '当日卖出笔数',
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  deleted TINYINT NOT NULL DEFAULT 0 COMMENT '逻辑删除：0否 1是',
